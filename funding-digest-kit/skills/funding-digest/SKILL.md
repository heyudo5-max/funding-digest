---
name: funding-digest
description: Research recent startup funding rounds and acquisitions, aggregate them into themes and metrics, derive insights useful to founders and VC-watchers, and draft a friendly short-form video script for TikTok, Instagram, and YouTube. Use this skill whenever the user wants a funding/M&A recap, a "this week/month/quarter/year in venture" roundup, a VC-trends digest, or a social video script about startup funding — even if they only say something like "what raised money last week," "do the monthly funding video," or "turn this week's rounds into a script."
---
...
**Paths in this file are relative to the repo root** (the folder you opened Claude Code in), so run from there.
